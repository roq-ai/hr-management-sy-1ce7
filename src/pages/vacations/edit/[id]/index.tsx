      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          <NumberInput
            ...
            formControlProps={{
              id: 'days_off',
              isInvalid: !!formik.errors?.days_off,
            }}
            name="days_off"
            error={formik.errors?.days_off}
            value={formik.values?.days_off}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('days_off', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
